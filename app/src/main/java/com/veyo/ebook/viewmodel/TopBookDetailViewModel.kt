 ...
 */
class TopBookDetailViewModel @Inject constructor(
    ...
    override fun init() {
        //Set toolbar title
        title.set("Top Book Detail")
    }

    fun getTopBookById(id: String?) {
        isLoading.set(true)
        repo.getTopBookDetail(id, object : OnCallbackListener<Response<Book>> {
